-- ============================================
-- INSERTAR NURY MARTINEZ COMPLETO DESDE CERO
-- ============================================
-- Este script inserta todo: usuario, intento, respuestas y resultado
-- Sin depender de IDs existentes
-- ============================================

-- 1. Insertar usuario
INSERT INTO usuarios (nombre_completo, cedula, tipo_usuario, fecha_registro) 
VALUES ('Nury Martinez', '51891837', 'estudiante', '2026-03-09 14:32:25');

-- Obtener el ID del usuario recién creado
SET @usuario_id = LAST_INSERT_ID();

-- 2. Insertar intento de examen
INSERT INTO intentos_examen (usuario_id, examen_id, fecha_inicio, fecha_fin, tiempo_segundos, estado) 
VALUES (@usuario_id, 1, '2026-03-09 14:32:25', '2026-03-09 14:53:36', 1271, 'finalizado');

-- Obtener el ID del intento recién creado
SET @intento_id = LAST_INSERT_ID();

-- 3. Insertar las 50 respuestas
...
SELECT 'NURY MARTINEZ INSERTADA EXITOSAMENTE:' as resultado;
SELECT 
    u.id as usuario_id,
    u.nombre_completo,
    u.cedula,
...
WHERE u.cedula = '51891837'
GROUP BY u.id, ie.id, r.id;

-- ============================================
-- RESUMEN
-- ============================================
-- ✅ Usuario: Nury Martinez (CI: 51891837)
-- ✅ Intento: Examen finalizado
-- ✅ Respuestas: 50 (34 correctas, 16 incorrectas)

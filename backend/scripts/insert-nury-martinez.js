/**
 * Script: Insertar usuario Nury Martinez con examen completado
 * Uso: node backend/scripts/insert-nury-martinez.js
 */
...
async function insertNuryMartinez() {
    let connection;
    ...
    try {
        ...
        // Leer el archivo SQL
        const sqlPath = join(__dirname, '../database/insert_nury_martinez.sql');
        ...
        console.log('📊 RESUMEN');
        console.log('═══════════════════════════════════════');
        console.log('Usuario: Nury Martinez');
